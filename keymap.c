 ...
 * `-----------+------+------+------+------+-------------'           `-------------+------+------+------+------+-----------'
 *     |       |      |      | LCTL | LCTL |                                       | RCTL | RCTL |      | REKBD|       |
 *     `-----------------------------------'                                       `-----------------------------------'
 *                                         ,-------------.           ,-------------.
 *                                         | LAlt | GUI  |           | MDIA | Del  |
 *                                  ,------|------|------|           |------+------+------.
 *                                  |      |      | Ctrl |           | LEAD |      |      |
 *                                  |Backsp| LGUI |------|           |------| RALT | Space|
 *                                  |      |      |LShift|           |RShift|      |      |
 *                                  `--------------------'           `--------------------'
 */
    [BASE] = KEYMAP(
        ...
        KC_NO,               KC_NO,         KC_NO,         F(F_LCTL),    F(F_LCTL),

        F(F_LALT), F(F_LGUI),
        F(F_LCTL),
        KC_BSPC,   F(F_LGUI),  F(F_LSFT),
        ...
        F(F_RCTL),           F(F_RCTL),     KC_NO,        M(REKBD),      TD(CT_SR),

        OSL(PROG), KC_DEL,
        KC_LEAD,
        F(F_RSFT), F(F_LALT), KC_SPC
        ),
/* Keymap 1: Prog Layer
 *
 * ,---------------------------------------------------.           ,--------------------------------------------------.
